namespace Moth.Tasks
{
    ...
    public interface ITaskDataStore
    {
        ...
        /// <param name="taskInfo"><see cref="ITaskInfo{T}"/> instance containing task type information.</param>
        ...
        /// <param name="taskInfo"><see cref="ITaskInfo{T}"/> instance containing task type information.</param>
        void Insert<T> (ref int dataIndex, ref int refIndex, in T task, ITaskInfo<T> taskInfo) where T : struct, ITaskType;

        /// <summary>
        /// Skips a task in the store.
        /// </summary>
        /// <param name="taskInfo"><see cref="ITaskInfo"/> instance containing task type information.</param>
